 ...
 */
package com.example.simplesheet.ui.theme

import androidx.compose.ui.graphics.Color

val md_theme_light_primary = Color(0xFF4dbf7a) // important buttons, etc.
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFF4dbf7a) // action button, etc.
val md_theme_light_onPrimaryContainer = Color(0xFFFFFFFF)
val md_theme_light_secondary = Color(0xFFC0C0C0) // dark color used for exceptions
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFFFFFFF) // dialogs, etc.
val md_theme_light_onSecondaryContainer = Color(0xFF422C31)
val md_theme_light_tertiary = Color(0xFFFF9320)
val md_theme_light_onTertiary = Color(0xFF422C31)
...
val md_theme_light_outline = Color(0xFFAAAAAA)
val md_theme_light_inverseOnSurface = Color(0xFFFFFFFF)
val md_theme_light_inverseSurface = Color(0x80E77485)
